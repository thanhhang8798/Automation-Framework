...
public class Login_27_CloudTesting_SauceLabs extends BaseTest {
    ...
    public void beforeClass(String environment, String platformName, String browserName, String browserVer) {
        ...
        driver = getBrowserDriverBySauceLabs(environmentConfig.getAppUrl(), platformName, browserName, browserVer);
