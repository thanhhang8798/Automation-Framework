...
public class Topic_08_Element_Component extends BaseTest{
    ...
    public void TC_01_Register() {
        ...
        adminLoginPage.enterToTextboxByID(driver, "Email", GlobalConstants.ADMIN_NOPCOMMERCE_EMAIL);
        adminLoginPage.enterToTextboxByID(driver, "Password", GlobalConstants.ADMIN_NOPCOMMERCE_PASSWORD);
